...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      cake.add_ingredient("strawberry")
      expect(cake.ingredients).to include("strawberry")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["flour", "strawberry", "cream", "egg"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("The Legendary Chef Leo")
      expect(cake.serve).to eq("The Legendary Chef Leo has made 10 cakes!")
    end
  end
